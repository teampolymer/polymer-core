...
public class CustomRenderTypes extends RenderType {
    ...
    public static final RenderState.TargetState SCHEMATIC_TARGET = new RenderState.TargetState("schematic_target", () -> {
//        VanillaShaderManager.schematicShader.getSchematicBuffer().bindWrite(false);
    }, () -> {
...
//            RenderSystem.blendFunc(GlStateManager.SourceFactor.CONSTANT_ALPHA, GlStateManager.DestFactor.ONE_MINUS_CONSTANT_ALPHA);
    ...
    protected static RenderState.TransparencyState getDynamicTransparency(float begin, float end, float period) {
        return new RenderState.TransparencyState("translucent_transparency_dynamic", () -> {
            ...
            alpha = MathHelper.clamp(alpha, 0.01f, 0.99f);
            RenderSystem.enableBlend();
//            RenderSystem.blendFunc(GlStateManager.SourceFactor.CONSTANT_ALPHA, GlStateManager.DestFactor.ONE_MINUS_CONSTANT_ALPHA);
...
//            .setTransparencyState(TRANSLUCENT_TRANSPARENCY)
            ...
            .setLightmapState(LIGHTMAP)
            .setOverlayState(OVERLAY)
            .setOutputState(SCHEMATIC_TARGET)
            .setWriteMaskState(COLOR_DEPTH_WRITE)
            .createCompositeState(true));
